...
```{r}
#| code-fold: true
#| code-summary: "Function to generate biwavelet analyses for multiple pairs"
library(janitor)
...
```{r}
#| code-fold: true
#| code-summary: "Prepare data for plotting"
...
biwavelet_plots <- plot_cwavelet_power(all_countries_coherence) 
...
```{r warning=FALSE, message=FALSE}
#| code-fold: true
#| code-summary: "Function to generate grid plot"
library(grid)
library(gridBase)
library(cowplot)
